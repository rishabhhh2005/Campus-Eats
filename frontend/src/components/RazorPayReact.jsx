...
const RazorPayReact = ({ amount, userId, purpose = 'umoney', orderId = null, onSuccess = () => {}, onOpen = () => {}, onClose = () => {}, children = 'Pay', autoOpen = false, testMode = false }) => {
  ...
  const handleTestPayment = async () => {
    ...
    options.modal = {
      ondismiss: function () {
        // user dismissed checkout - don't create order
    ...
    // Auto-complete payment after a short delay
    setTimeout(() => {
      // Simulate successful payment by calling handler directly
      const mockResponse = {
        razorpay_order_id: order.id,
        razorpay_payment_id: `pay_test_${Date.now()}`,
        razorpay_signature: 'test_signature_auto'
      };
      options.handler(mockResponse);
    }, 2000); // 2 second delay to show Razorpay opened
